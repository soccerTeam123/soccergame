...
//        artist.getSongList().push(songName);
    ...
    public boolean isRegistered(String artistName) {
        return findArtistByName(artistName) != null;    //=null  + ar.isRegistered ??
    }
    ...
    public boolean addNewSong(String artistName, String songName) {
        ...
        StringList songList = foundArtist.getSongList();   //getSongList()어떻게 사용?
        //3. 그 노래목록에 새노래를 추가한다.
    ...
    public String[] getSongList(String artistName) {
        return findArtistByName(artistName).getSongList().getsArr();   //getsArr()?????
    }
